...
class Questions(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "resposta_certa = ANY (ARRAY['A'::bpchar, 'B'::bpchar, 'C'::bpchar, 'D'::bpchar])",
            name="questions_resposta_certa_check",
        ),
...
class Users(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["profile_id"], ["profiles.id"], name="users_profile_id_fkey"
        ),
