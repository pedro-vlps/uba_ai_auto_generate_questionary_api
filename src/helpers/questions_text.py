...
ANATOMY_QUESTION = (
    ...
    "- The question MUST stay within {SUB_TOPIC}\n"
    ...
    "- All options must belong to the SAME anatomical category\n"
    ...
    "4. Place correct answer in {CORRECT_LETTER}\n"
    "5. Set correct_answer = {CORRECT_LETTER}\n\n"

    "EXPLANATIONS:\n"
    "- Correct: explain specifically why it is correct\n"
    "- Incorrect: explain why it is incorrect (anatomical reasoning)\n"
