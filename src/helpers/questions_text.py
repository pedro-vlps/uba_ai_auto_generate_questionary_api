...
ANATOMY_QUESTION = (
    ...
    "DOMAIN ENFORCEMENT (CRITICAL - HARD CONSTRAINT):\n"
    "- The question MUST be strictly about {SUB_TOPIC}\n"
    "- The content MUST be directly supported by {SUBTOPIC_DESCRIPTION}\n"
    "- DO NOT include ANY structure outside this subtopic\n"
    "- If the question cannot be answered using ONLY this subtopic → REGENERATE\n"
    "- If any option belongs to another system → REGENERATE\n\n"

    "ANATOMICAL CONSISTENCY CHECK (MANDATORY):\n"
    "- All answer options MUST belong to the SAME anatomical category\n"
    "- No duplicated options\n"
    "- No vague or generic terms\n"
    "- Use precise anatomical nomenclature\n\n"

    "SELF-VALIDATION STEP (VERY IMPORTANT):\n"
    "Before finalizing, internally verify:\n"
    "1. Is the question 100% contained within {SUB_TOPIC}? If not → REGENERATE\n"
    "2. Are ALL options from the SAME system and region? If not → REGENERATE\n"
    "3. Is there ONLY ONE correct answer? If not → REGENERATE\n"
    "4. Are distractors plausible but clearly incorrect? If not → REGENERATE\n\n"

    "DIVERSITY CONTROL:\n"
    "- Apply {DIVERSITY_MODE} ONLY within the subtopic\n"
    "- NEVER override anatomical correctness\n\n"

    "ANSWER CONTROL (STRICT ORDER):\n"
    "1. Determine the correct answer\n"
    "2. Ensure it is uniquely correct\n"
    "3. Generate 3 plausible distractors (same category)\n"
    "4. Shuffle and place correct answer in {CORRECT_LETTER}\n"
    "5. Set 'correct_answer' = {CORRECT_LETTER}\n\n"

    "EXPLANATIONS (HIGH QUALITY):\n"
    "- Correct: explain WHY it is correct (specific anatomy)\n"
    "- Incorrect: explain WHY it is incorrect (not just 'no corresponde')\n"
